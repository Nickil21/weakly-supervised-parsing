...
#         start_exclude_list = ['and', 'or', "'s", "n't", 'said', 'says', '&', 'but']
#         end_exclude_list = ['and', 'or', 'is', 'said', 'says', '&', 'but']
#         best_parse = RuleBasedHeuristic(sentence=self.sentence).delete_false_constituents(best_parse, start_exclude_list=start_exclude_list, end_exclude_list=end_exclude_list)
        return best_parse
