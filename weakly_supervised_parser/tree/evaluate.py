...
def calculate_F1_for_spans(gold_spans, pred_spans, precision_recall_f_score=False):
    ...
    if precision_recall_f_score:
        p, r, F1 = calculate_F1_score_from_intermediates(tp, len(gold_spans), len(pred_spans),
...
def parse_args():
    ...
    parser.add_argument("--len_limit", default=None, type=int, choices=(None, 10, 20, 30, 40, 50, 100),
