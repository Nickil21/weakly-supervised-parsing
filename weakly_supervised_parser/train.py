...
def cli_main():
    ...
    parser.add_argument("--train_data_path", type=str, default=INSIDE_BOOTSTRAPPED_DATASET_PATH + "train.csv",
                       help="The csv file containing the training data")
    
    parser.add_argument("--validation_data_path", type=str, default=INSIDE_BOOTSTRAPPED_DATASET_PATH + "validation.csv",
                       help="The csv file containing the validation data")
    
    parser.add_argument("--model_variant", type=str, required=True,
                        help="Options include (inside_model/inside_self_trained_model/inside_outside_co_trained_model)")
        
    parser.add_argument("--output_dir", type=str, default=INSIDE_MODEL_PATH,
    ...
    parser.add_argument("--num_workers", default=16, type=int,
                       help="Number of workers used in the data loader")
    
    parser.add_argument("--max_seq_length", default=192, type=int,
    ...
    # data
    # ------------
    data_module = DataModule(model_name_or_path=args.model_name_or_path, 
