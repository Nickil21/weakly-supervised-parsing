...
def get_data_ptb(root, output):
  ...
  save_file(train_file_ids, os.path.join(output, "ptb-train-gold.txt"), save_gold=True)
  ...
  save_file(train_file_ids, os.path.join(output, "ptb-train-sentences-with-punctuation.txt"), include_punctuation=True)
  save_file(val_file_ids, os.path.join(output, "ptb-valid-sentences-with-punctuation.txt"), include_punctuation=True)
  save_file(test_file_ids, os.path.join(output, "ptb-test-sentences-with-punctuation.txt"), include_punctuation=True)

  save_file(train_file_ids, os.path.join(output, "ptb-train-sentences-without-punctuation.txt"), include_punctuation=False)
  save_file(val_file_ids, os.path.join(output, "ptb-valid-sentences-without-punctuation.txt"), include_punctuation=False)
  save_file(test_file_ids, os.path.join(output, "ptb-test-sentences-without-punctuation.txt"), include_punctuation=False)
